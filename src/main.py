...
def get_scores(data: Dataset, model_checkpoint: str, data_type: str, device: str = "cuda:0", BLOOM: bool = False):
    ...
    # tokenizer.decode(tokenizer(data['context'])['input_ids'][0])
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', help='enter model name', default="IProject-10/xlm-roberta-base-finetuned-squad2", required=False)
